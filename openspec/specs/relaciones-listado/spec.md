# relaciones-listado Specification

## Purpose
Aprovechar lo que el listado de la CMF publica sobre qué normas modifica y deroga cada documento —columnas «Modifica a» y «Deroga a»—, guardándolo aparte de lo que se extrae del PDF y usándolo en el dashboard como piso de las normas afectadas y segunda fuente de la acción. Origen: `openspec/changes/archive/2026-09-16-relaciones-del-listado/`.
## Requirements
